...
PARK_HOST_URL = 'http://121.131.8.68'
LOGIN_URL = '/login'
...
class eccbot(BotInterface):
    ...
    def login(self):
        try:
            login_req = self.s.post(PARK_HOST_URL + LOGIN_URL + "?" + u"referer=&userId=%EC%B9%B4%EC%B9%B4%EC%98%A4t&userPwd=2580")
            return True
